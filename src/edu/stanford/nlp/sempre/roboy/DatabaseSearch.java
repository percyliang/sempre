...
/**
 * Looks for certain keyword in different Databases APIs
 *
 * @maintainer Emilia Lozinska
 *
 * Based on FreebaseSearch class
 * @author Percy Liang
 *
 */
public class DatabaseSearch {
  ...
  public ServerResponse lookup(String query) {
    ...
    // TODO: Analyze types differently
    // Parse the result
    ...
    LogInfo.logs("DatabaseSearch %s => %s results (cached=%s)", query, response.entries.size(), response.cached);
    return response;
  }
  ...
  public static void main(String[] args) {
    opts.cachePath = "DatabaseSearch.cache";
