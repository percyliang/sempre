 ...
 * @author emlozin
 */
public class UnspecInfo implements MemUsage.Instrumented {
    ...
    public UnspecInfo(String term, TermType type) {
        this.term = term;
        this.type = type;
    }

    public void addCandidates(UnspecInfo newTerm){
        // Add all to list
    ...
    public void addScores(UnspecInfo newTerm){
        // Add all to list
